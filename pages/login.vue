...
let user = reactive({email: 'tijanmdr@gmail.com',password: 'tijanmdr', user_access_level:1})

async function formCheck (event:Event) {
...
<template>
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" @submit="formCheck" method="post">
        <div>
        ...
        <div>
          <button type="submit" @click="formCheck"
